 ...
 * Author: sakr3
 *
 * Created on February 10, 2024, 11:19 AM
 */
 ...
 * @note   ADC_CONVERTER_ENABLE()  : Enable the Analog-To-Digital module
 *         ADC_CONVERTER_DISABLE() : Disable the Analog-To-Digital module
 */
 ...
 * @note   ADC_ENABLE_VOLTAGE_REFERENCE()  : Voltage Reference is VREF- & VREF+ (AN2, AN3)
 *         ADC_DISABLE_VOLTAGE_REFERENCE() : Voltage Reference is VSS & VDD
 */
#define ADC_ENABLE_VOLTAGE_REFERANCE() do{ADCON1bits.VCFG0 = ADC_VOLTAGE_REFERANCE_ENABLE;\
                                          ADCON1bits.VCFG1 = ADC_VOLTAGE_REFERANCE_ENABLE;\
                                         }while(0)

#define ADC_DISABLE_VOLTAGE_REFERANCE() do{ADCON1bits.VCFG0 = ADC_VOLTAGE_REFERANCE_DISABLE;\
                                           ADCON1bits.VCFG1 = ADC_VOLTAGE_REFERANCE_DISABLE;\
                                         }while(0)
