 ...
 * @Preconditions ADC_Init() function should have been called before this function.
 * @param _adc Pointer to the ADC configurations
...
/**
 * @Summary Start the ADC conversion, also allows selection of a channel for conversion.
 * @Description This routine is used to select desired channel for conversion.
 *              This routine is start the analog to digital conversion.
 * @Preconditions ADC_Init() function should have been called before calling this function.
 * @param _adc Pointer to the ADC configurations
 * @param channel Defines the channel available for conversion.
 * @return Status of the function
...
/**
 * ADC Module interrupt ISR
 */
void ADC_ISR(void){
    /* The ADC Module interrupt occurred (must be cleared in software) */
    ADC_InterruptFlagClear();
