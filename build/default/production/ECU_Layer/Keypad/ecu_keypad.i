...
# 51 "ECU_Layer/Keypad/ecu_keypad.c"
Std_ReturnType keypad_get_value(const keypad_t *_keypad_obj, uint8 *value) {
    Std_ReturnType ret = (Std_ReturnType)0x00;
    if ((((void*)0) == _keypad_obj) || (((void*)0) == value)) {
        ret = (Std_ReturnType)0x01;
    } else {
        uint8 l_rows_counter = 0X00, l_columns_counter = 0X00, l_counter = 0X00;
        uint8 column_logic = GPIO_LOGIC_LOW;


        for (l_rows_counter = 0X00; l_rows_counter < 4; l_rows_counter++){
            ...
            for (l_columns_counter = 0X00; l_columns_counter < 4; l_columns_counter++){
