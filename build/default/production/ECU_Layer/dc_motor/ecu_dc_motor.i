...
# 2 "ECU_Layer/dc_motor/ecu_dc_motor.c" 2
# 11 "ECU_Layer/dc_motor/ecu_dc_motor.c"
Std_ReturnType dc_motor_intialize(const dc_motor_t *_dc_motor){
...
# 30 "ECU_Layer/dc_motor/ecu_dc_motor.c"
Std_ReturnType dc_motor_move_right(const dc_motor_t *_dc_motor){
    Std_ReturnType ret = (Std_ReturnType)0x00;
    if (((void*)0) == _dc_motor) {
        ret = (Std_ReturnType)0x01;
    } else {
        ret = gpio_pin_write_logic(&(_dc_motor->dc_motor_pin[0x00U]), GPIO_LOGIC_HIGH);
        ret = gpio_pin_write_logic(&(_dc_motor->dc_motor_pin[0x01U]), GPIO_LOGIC_LOW);
    }
...
Std_ReturnType dc_motor_move_left(const dc_motor_t *_dc_motor){
    ...
    if (((void*)0) == _dc_motor) {
        ...
        ret = gpio_pin_write_logic(&(_dc_motor->dc_motor_pin[0x00U]), GPIO_LOGIC_LOW);
        ret = gpio_pin_write_logic(&(_dc_motor->dc_motor_pin[0x01U]), GPIO_LOGIC_HIGH);
    }

    return ret;
}
# 68 "ECU_Layer/dc_motor/ecu_dc_motor.c"
Std_ReturnType dc_motor_stop(const dc_motor_t *_dc_motor){
    Std_ReturnType ret = (Std_ReturnType)0x00;
    if (((void*)0) == _dc_motor) {
        ret = (Std_ReturnType)0x01;
