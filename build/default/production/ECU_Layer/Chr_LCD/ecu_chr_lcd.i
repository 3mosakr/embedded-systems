...
# 33 "ECU_Layer/Chr_LCD/../../MCAL_Layer/GPIO/hal_gpio.h"
typedef enum {
    GPIO_LOGIC_LOW = 0,
    GPIO_LOGIC_HIGH
}logic_t;
...
# 95 "ECU_Layer/Chr_LCD/ecu_chr_lcd.c"
Std_ReturnType lcd_4bit_send_char_data(const chr_lcd_4bit_t *lcd, uint8 data) {
    Std_ReturnType ret = (Std_ReturnType)0x00;
    if (((void*)0) == lcd) {
        ret = (Std_ReturnType)0x01;
...
# 148 "ECU_Layer/Chr_LCD/ecu_chr_lcd.c"
Std_ReturnType lcd_4bit_send_string(const chr_lcd_4bit_t *lcd, uint8 *str) {
    Std_ReturnType ret = (Std_ReturnType)0x00;
    if (((void*)0) == lcd) {
        ret = (Std_ReturnType)0x01;
...
# 174 "ECU_Layer/Chr_LCD/ecu_chr_lcd.c"
Std_ReturnType lcd_4bit_send_string_pos(const chr_lcd_4bit_t *lcd, uint8 row, uint8 column, uint8 *str) {
    Std_ReturnType ret = (Std_ReturnType)0x00;
    if (((void*)0) == lcd) {
        ret = (Std_ReturnType)0x01;
...
# 291 "ECU_Layer/Chr_LCD/ecu_chr_lcd.c"
Std_ReturnType lcd_8bit_send_char_data(const chr_lcd_8bit_t *lcd, uint8 data) {
    Std_ReturnType ret = (Std_ReturnType)0x00;
    if (((void*)0) == lcd) {
        ret = (Std_ReturnType)0x01;
...
# 317 "ECU_Layer/Chr_LCD/ecu_chr_lcd.c"
Std_ReturnType lcd_8bit_send_char_data_pos(const chr_lcd_8bit_t *lcd, uint8 row, uint8 column, uint8 data) {
    Std_ReturnType ret = (Std_ReturnType)0x00;
    if (((void*)0) == lcd) {
        ret = (Std_ReturnType)0x01;
...
# 364 "ECU_Layer/Chr_LCD/ecu_chr_lcd.c"
Std_ReturnType lcd_8bit_send_string_pos(const chr_lcd_8bit_t *lcd, uint8 row, uint8 column, uint8 *str) {
    Std_ReturnType ret = (Std_ReturnType)0x00;
    if (((void*)0) == lcd) {
        ret = (Std_ReturnType)0x01;
...
# 390 "ECU_Layer/Chr_LCD/ecu_chr_lcd.c"
Std_ReturnType lcd_8bit_send_custom_char(const chr_lcd_8bit_t *lcd, uint8 row, uint8 column,
                                            const uint8 _chr[], uint8 mem_pos) {
    Std_ReturnType ret = (Std_ReturnType)0x00;
    if (((void*)0) == lcd) {
...
# 421 "ECU_Layer/Chr_LCD/ecu_chr_lcd.c"
Std_ReturnType convert_uint8_to_string(uint8 value, uint8 *str) {
    Std_ReturnType ret = (Std_ReturnType)0x00;
...
# 477 "ECU_Layer/Chr_LCD/ecu_chr_lcd.c"
Std_ReturnType convert_uint32_to_string(uint32 value, uint8 *str) {
    Std_ReturnType ret = (Std_ReturnType)0x00;
...
# 507 "ECU_Layer/Chr_LCD/ecu_chr_lcd.c"
static Std_ReturnType lcd_send_4bits(const chr_lcd_8bit_t *lcd, uint8 data_command) {
    Std_ReturnType ret = (Std_ReturnType)0x00;
    if (((void*)0) == lcd) {
        ret = (Std_ReturnType)0x01;
        ...
        for (l_pin_counter = 0; l_pin_counter < 4; ++l_pin_counter) {
            ret = gpio_pin_write_logic(&(lcd->lcd_data[l_pin_counter]), ((data_command >> l_pin_counter) & (uint8)0x01));
        }
    }

    return ret;
}
# 530 "ECU_Layer/Chr_LCD/ecu_chr_lcd.c"
static Std_ReturnType lcd_send_8bits(const chr_lcd_8bit_t *lcd, uint8 data_command) {
    Std_ReturnType ret = (Std_ReturnType)0x00;
    if (((void*)0) == lcd) {
        ret = (Std_ReturnType)0x01;
...
static Std_ReturnType lcd_4bit_set_cursor(const chr_lcd_8bit_t *lcd, uint8 row, uint8 column) {
    ...
    if (((void*)0) == lcd) {
        ...
        column--;
        switch (row) {
            case 0x01: lcd_4bit_send_command(lcd, (0x80 + column));
                break;
            case 0x02: lcd_4bit_send_command(lcd, (0xc0 + column));
                break;
            case 0x03: lcd_4bit_send_command(lcd, (0x94 + column));
                break;
            case 0x04: lcd_4bit_send_command(lcd, (0xd4 + column));
                break;
            default: break;
        }
    }
...
# 586 "ECU_Layer/Chr_LCD/ecu_chr_lcd.c"
static Std_ReturnType lcd_8bit_set_cursor(const chr_lcd_8bit_t *lcd, uint8 row, uint8 column) {
    Std_ReturnType ret = (Std_ReturnType)0x00;
    if (((void*)0) == lcd) {
        ret = (Std_ReturnType)0x01;
        ...
        column--;
        switch (row) {
            case 0x01: lcd_8bit_send_command(lcd, (0x80 + column));
                break;
            case 0x02: lcd_8bit_send_command(lcd, (0xc0 + column));
                break;
            case 0x03: lcd_8bit_send_command(lcd, (0x94 + column));
                break;
            case 0x04: lcd_8bit_send_command(lcd, (0xd4 + column));
                break;
            default: break;
        }
    }
...
# 616 "ECU_Layer/Chr_LCD/ecu_chr_lcd.c"
static Std_ReturnType lcd_send_enable_signal(const chr_lcd_8bit_t *lcd) {
    Std_ReturnType ret = (Std_ReturnType)0x00;
    if (((void*)0) == lcd) {
        ret = (Std_ReturnType)0x01;
