...
# 14 "MCAL_Layer/ADC/../Interrupt/../GPIO/hal_gpio.h"
# 1 "MCAL_Layer/ADC/../Interrupt/../GPIO/../device_config.h" 1
# 14 "MCAL_Layer/ADC/../Interrupt/../GPIO/hal_gpio.h" 2

# 1 "MCAL_Layer/ADC/../Interrupt/../GPIO/hal_gpio_cfg.h" 1
# 15 "MCAL_Layer/ADC/../Interrupt/../GPIO/hal_gpio.h" 2
# 33 "MCAL_Layer/ADC/../Interrupt/../GPIO/hal_gpio.h"
typedef enum {
    GPIO_LOGIC_LOW = 0,
    GPIO_LOGIC_HIGH
}logic_t;
...
# 66 "MCAL_Layer/ADC/../Interrupt/mcal_interrupt_config.h"
typedef enum {
...
# 169 "MCAL_Layer/ADC/hal_adc.c"
Std_ReturnType ADC_GetConversionResult(const adc_conf_t *_adc, adc_result_t *conversion_result) {
    Std_ReturnType ret = (Std_ReturnType)0x00;
    if ((((void*)0) == _adc) || (((void*)0) == conversion_result)) {
        ret = (Std_ReturnType)0x01;
    } else {
        if (0x00U == _adc->result_format) {
...
# 258 "MCAL_Layer/ADC/hal_adc.c"
static __attribute__((inline)) void adc_input_channel_port_configure(adc_channel_select_t channel) {
    switch (channel) {
        case ADC_CHANNEL_AN0: (TRISA |= ((uint8)0x01 << 0x0));
            break;
        case ADC_CHANNEL_AN1: (TRISA |= ((uint8)0x01 << 0x1));
            break;
        case ADC_CHANNEL_AN2: (TRISA |= ((uint8)0x01 << 0x2));
            break;
        case ADC_CHANNEL_AN3: (TRISA |= ((uint8)0x01 << 0x3));
            break;
        case ADC_CHANNEL_AN4: (TRISA |= ((uint8)0x01 << 0x5));
            break;
        case ADC_CHANNEL_AN5: (TRISE |= ((uint8)0x01 << 0x0));
            break;
        case ADC_CHANNEL_AN6: (TRISE |= ((uint8)0x01 << 0x1));
            break;
        case ADC_CHANNEL_AN7: (TRISE |= ((uint8)0x01 << 0x2));
            break;
        case ADC_CHANNEL_AN8: (TRISB |= ((uint8)0x01 << 0x2));
            break;
        case ADC_CHANNEL_AN9: (TRISB |= ((uint8)0x01 << 0x3));
            break;
        case ADC_CHANNEL_AN10: (TRISB |= ((uint8)0x01 << 0x1));
            break;
        case ADC_CHANNEL_AN11: (TRISB |= ((uint8)0x01 << 0x4));
            break;
        case ADC_CHANNEL_AN12: (TRISB |= ((uint8)0x01 << 0x0));
            break;
        default: break;
    }
}
...
static __attribute__((inline)) void select_result_format(const adc_conf_t *_adc) {
    if (0x00U == _adc->result_format) {
        (ADCON2bits.ADFM = 0x00U);
    } else {
        (ADCON2bits.ADFM = 0x01U);
    }
}
...
static __attribute__((inline)) void configure_voltage_reference(const adc_conf_t *_adc) {
    if (0x01U == _adc->voltage_reference) {
        do{ADCON1bits.VCFG0 = 0x01U; ADCON1bits.VCFG1 = 0x01U; }while(0);
    } else {
        do{ADCON1bits.VCFG0 = 0x00U; ADCON1bits.VCFG1 = 0x00U; }while(0);
    }
}
